...
## Overview
A SignatureProvider for communicating with [eosjs](https://github.com/ARISEN/eosjs) from a Ledger device.

When plugged into `eosjs`, this signature provider enables applications to route signing requests to a Ledger device. Full instructions for `eosjs` can be found [here](https://github.com/ARISEN/eosjs).
...
const serializedTransaction = {} // A transaction as a Uint8Array. View `serializeTransaction` in https://github.com/ARISEN/eosjs/blob/develop/src/eosjs-api.ts
